...
export class AiServicesClient {
	...
	extractEntities(
		...
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_aiservices_pb.ExtractEntitiesResponse) => void
	...
	generateUserSays(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_aiservices_pb.GenerateUserSaysResponse) => void
	...
	generateResponses(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_aiservices_pb.GenerateResponsesResponse) => void
	...
	getAlternativeSentences(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_aiservices_pb.GetAlternativeSentencesResponse) => void
	...
	getAlternativeTrainingPhrases(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_aiservices_pb.GetAlternativeTrainingPhrasesResponse) => void
	...
	getSynonyms(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_aiservices_pb.GetSynonymsResponse) => void
	...
	classifyIntents(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_aiservices_pb.ClassifyIntentsResponse) => void

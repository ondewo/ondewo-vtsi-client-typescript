...
export class IntentsClient {
	...
	listIntents(
		...
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_intent_pb.ListIntentsResponse) => void
	): grpcWeb.ClientReadableStream<ondewo_nlu_intent_pb.ListIntentsResponse>;

	getIntent(
		request: ondewo_nlu_intent_pb.GetIntentRequest,
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_intent_pb.Intent) => void
	...
	getIntentTags(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_intent_pb.GetIntentTagsResponse) => void
	...
	batchCreateTrainingPhrases(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_intent_pb.BatchTrainingPhrasesStatusResponse) => void
	...
	batchDeleteTrainingPhrases(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_intent_pb.BatchDeleteTrainingPhrasesResponse) => void
	...
	listTrainingPhrases(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_intent_pb.ListTrainingPhrasesResponse) => void
	...
	batchCreateResponseMessages(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_intent_pb.BatchResponseMessagesStatusResponse) => void
	...
	batchDeleteResponseMessages(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_intent_pb.BatchDeleteResponseMessagesResponse) => void
	...
	listResponseMessages(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_intent_pb.ListResponseMessagesResponse) => void
	...
	batchCreateParameters(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_intent_pb.BatchParametersStatusResponse) => void
	...
	batchDeleteParameters(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_intent_pb.BatchDeleteParametersResponse) => void
	...
	listParameters(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_nlu_intent_pb.ListParametersResponse) => void
	...
	listTrainingPhrasesofIntentsWithEnrichment(
		...
		callback: (
			...
			response: ondewo_nlu_intent_pb.ListTrainingPhrasesofIntentsWithEnrichmentResponse
		) => void

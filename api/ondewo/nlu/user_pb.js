	...
	proto.ondewo.nlu.UserInfo.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				projectRolesMap: (f = msg.getProjectRolesMap())
					? f.toObject(includeInstance, proto.ondewo.nlu.ProjectRole.toObject)
					: []
			};
			...
			case 2:
				...
				reader.readMessage(value, function (message, reader) {
					jspb.Map.deserializeBinary(
						...
						'',
						new proto.ondewo.nlu.ProjectRole()
					);
				});
				break;
			default:
...
proto.ondewo.nlu.UserInfo.serializeBinaryToWriter = function (message, writer) {
	...
	f = message.getUser();
	if (f != null) {
		writer.writeMessage(1, f, proto.ondewo.nlu.User.serializeBinaryToWriter);
	}
...
proto.ondewo.nlu.UserInfo.prototype.getUser = function () {
	return /** @type{?proto.ondewo.nlu.User} */ (jspb.Message.getWrapperField(this, proto.ondewo.nlu.User, 1));
};
...
proto.ondewo.nlu.UserInfo.prototype.getProjectRolesMap = function (opt_noLazyCreate) {
	return /** @type {!jspb.Map<string,!proto.ondewo.nlu.ProjectRole>} */ (
		jspb.Message.getMapField(this, 2, opt_noLazyCreate, proto.ondewo.nlu.ProjectRole)
	);
};
...
proto.ondewo.nlu.GetUserRequest.prototype.getUserIdentifierCase = function () {
	return /** @type {proto.ondewo.nlu.GetUserRequest.UserIdentifierCase} */ (
		jspb.Message.computeOneofCase(this, proto.ondewo.nlu.GetUserRequest.oneofGroups_[0])
	);
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	...
	proto.ondewo.nlu.ListUsersResponse.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				usersList: jspb.Message.toObjectList(msg.getUsersList(), proto.ondewo.nlu.User.toObject, includeInstance),
...
proto.ondewo.nlu.ListUsersResponse.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(1, f, proto.ondewo.nlu.User.serializeBinaryToWriter);
	}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	...
	proto.ondewo.nlu.ListUserInfosResponse.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				usersList: jspb.Message.toObjectList(msg.getUsersList(), proto.ondewo.nlu.UserInfo.toObject, includeInstance),
				nextPageToken: jspb.Message.getFieldWithDefault(msg, 2, '')
			};
...
proto.ondewo.nlu.ListUserInfosResponse.serializeBinaryToWriter = function (message, writer) {
	...
	f = message.getUsersList();
	if (f.length > 0) {
		writer.writeRepeatedMessage(1, f, proto.ondewo.nlu.UserInfo.serializeBinaryToWriter);
	}
	f = message.getNextPageToken();
	if (f.length > 0) {
		writer.writeString(2, f);
...
proto.ondewo.nlu.CreateServerRoleRequest.serializeBinaryToWriter = function (message, writer) {
	...
	f = message.getRole();
	if (f != null) {
		writer.writeMessage(1, f, proto.ondewo.nlu.ServerRole.serializeBinaryToWriter);
	}
};
...
proto.ondewo.nlu.GetServerRoleRequest.prototype.getServerRoleIdentifierCase = function () {
	return /** @type {proto.ondewo.nlu.GetServerRoleRequest.ServerRoleIdentifierCase} */ (
		jspb.Message.computeOneofCase(this, proto.ondewo.nlu.GetServerRoleRequest.oneofGroups_[0])
	);
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	...
	proto.ondewo.nlu.ListServerRolesResponse.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				serverRolesList: jspb.Message.toObjectList(
					msg.getServerRolesList(),
					proto.ondewo.nlu.ServerRole.toObject,
					includeInstance
				),
				nextPageToken: jspb.Message.getFieldWithDefault(msg, 2, '')
			};
...
proto.ondewo.nlu.ListServerRolesResponse.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(1, f, proto.ondewo.nlu.ServerRole.serializeBinaryToWriter);
	}
	f = message.getNextPageToken();
	if (f.length > 0) {
		writer.writeString(2, f);

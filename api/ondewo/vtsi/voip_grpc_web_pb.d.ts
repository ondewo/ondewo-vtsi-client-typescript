...
export class VoipSessionsClient {
	...
	getProjectConfigs(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_vtsi_voip_pb.GetProjectConfigsResponse) => void
	...
	startListeners(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_vtsi_voip_pb.StartListenersResponse) => void
	): grpcWeb.ClientReadableStream<ondewo_vtsi_voip_pb.StartListenersResponse>;

	startCallers(
		request: ondewo_vtsi_voip_pb.StartCallersRequest,
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_vtsi_voip_pb.StartCallersResponse) => void
	...
	getVoipCallInfo(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_vtsi_voip_pb.GetVoipCallInfoResponse) => void
	...
	listVoipCallInfo(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_vtsi_voip_pb.ListVoipCallInfoResponse) => void
	): grpcWeb.ClientReadableStream<ondewo_vtsi_voip_pb.ListVoipCallInfoResponse>;

	getAudioFile(
		request: ondewo_vtsi_voip_pb.GetAudioFileRequest,
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_vtsi_voip_pb.GetAudioFileResponse) => void
	...
	getFullConversationAudioFile(
		...
		metadata: grpcWeb.Metadata | undefined,
		callback: (err: grpcWeb.RpcError, response: ondewo_vtsi_voip_pb.GetFullConversationAudioFileResponse) => void

...
export class GetFullConversationAudioFileRequest extends jspb.Message {
	...
	static toObject(
		includeInstance: boolean,
		msg: GetFullConversationAudioFileRequest
	): GetFullConversationAudioFileRequest.AsObject;
...
export class GetFullConversationAudioFileResponse extends jspb.Message {
	...
	static toObject(
		includeInstance: boolean,
		msg: GetFullConversationAudioFileResponse
	): GetFullConversationAudioFileResponse.AsObject;
